      ...
      <div className="bg-white w-[90%] max-w-lg max-h-[80vh] rounded-2xl flex flex-col shadow-2xl overflow-hidden">
        ...
        <div className="p-4 border-t flex justify-between items-center bg-white">
          <div className="text-sm text-gray-600">
            已选: <span className="font-bold text-blue-600 text-lg">{tempSelection.size}</span> 个场次
          </div>
          <button
            onClick={handleConfirm}
            className="px-8 py-2.5 bg-blue-600 text-white rounded-full hover:bg-blue-700 font-bold transition-all shadow-lg shadow-blue-200 active:scale-95"
          >
            确认选择
          </button>
        </div>
